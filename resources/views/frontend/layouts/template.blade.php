                            ...
                            <div class="popup popup--left">
                                ...
                                <div class="popup__content">
                                    ...
                                    @else
                                        <div class="account">
                                            ...
                                            <div class="account-sub">
                                                <ul>
                                                    <li class="{{isActiveMenu('user_profile')}}"><a href="{{route('user_profile')}}">{{__('Perfil')}}</a></li>
                                                    <li class="{{isActiveMenu('user_my_place')}}"><a href="{{route('user_my_place')}}">{{__('Mis lugares')}}</a></li>
                                                    <li class="{{isActiveMenu('user_wishlist')}}"><a href="{{route('user_wishlist')}}">{{__('Gustos')}}</a></li>
                                                    <li>
                                    ...
                                    <div class="popup__destinations popup__box">
                                        <ul class="menu-arrow">
                                            <li>
                                                <a title="Destinations" href="#">{{__('Destinos')}}</a>
                                                <ul class="sub-menu">
                                    ...
                                    <div class="popup__menu popup__box">
                                        <ul class="menu-arrow">
                                            <li>
                                                <a title="Home demo" href="{{route('home')}}">Inicio</a>
                                                <ul class="sub-menu">
    ...
    <footer id="footer" class="footer">
        <div class="container">
            ...
            <div class="footer__bottom">
                <p class="footer__bottom__copyright">{{now()->year}} &copy; <a href="{{__('https://google.com')}}" target="_blank">{{__('Grupo 5 ITB')}}</a>. {{__('Todos los derecho.')}}</p>
            </div><!-- .top-footer -->
        </div><!-- .container -->
    </footer><!-- site-footer -->
</div><!-- #wrapper -->

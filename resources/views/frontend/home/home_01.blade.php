...
@section('main')
    <main id="main" class="site-main">
        <div class="site-banner" {{$home_banner}}>
            <div class="container">
                <div class="site-banner__content golo-ajax-search">
                    <h1 class="site-banner__title">Explore el país</h1>
                    <form action="{{route('search')}}" class="site-banner__search">
                        <div class="site-banner__search__field">
                            ...
                            <input class="site-banner__search__input" type="text" name="keyword" placeholder="{{__('Escriba la ciudad o ubicación')}}" autocomplete="off">
                            <div class="search-result"></div>
                            <div class="golo-loading-effect"><span class="golo-dual-ring"></span></div>
                        </div>
                    </form>
                    <p class="site-banner__meta">
                        <span>{{__('Mas Buscados:')}}</span>
        ...
        <div class="cities">
            <div class="container">
                <h2 class="cities__title title">{{__('Ciudades mas buscadas')}}</h2>
                            ...
                            <div class="col-lg-3 col-sm-6">
                                <div class="cities__item hover__box">
                                    ...
                                    <div class="cities__info">
                                        ...
                                        <p class="cities__number">{{$city->places_count}} {{__('Lugares')}}</p>
                                    </div>
                                </div>
                            </div>
                        @endforeach
        ...
        {{-- <div class="banner-apps" {{$home_banner_app}}>
            <div class="container">
                <div class="banner-apps__content">
                    <h2 class="banner-apps__title">{{__('Proximamente APP')}}</h2>
                    <p class="banner-apps__desc">{{__('Podras descargar una .')}}</p>
        ...
        <div class="news">
            <div class="container">
                <h2 class="news__title title title--more">
                    {{__('Historias')}}
                    <a href="{{route('post_list_all')}}" title="{{__('Ver mas')}}">
                        {{__('Ver mas')}}
